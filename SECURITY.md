...
We take security vulnerabilities seriously. If you discover a vulnerability in Beacon, please report it privately to [your_contact_email@example.com] instead of opening a public issue. We will work to address it promptly.
